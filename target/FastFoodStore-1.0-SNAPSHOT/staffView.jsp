                    ...
                    <div class="position-sticky">
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white min-vh-100">
                            ...
                            <ul class="nav nav-pills flex-column mb-auto w-100">
                                ...
                                <li class="nav-item w-100">
                                    ...
                                    <div class="collapse" id="workScheduleSubmenu">
                                        <ul class="list-unstyled ms-4">
                                            <li class="nav-item">
                                                <a href="/StaffSchedule/viewWorkScheduleForStaff" class="sidebar-link d-flex align-items-center py-2">
                                                    <i class="fas fa-eye me-2"></i> Xem lịch làm việc
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="/ShiftRegistration/createShiftRegistration" class="sidebar-link d-flex align-items-center py-2">
                                                    <i class="fas fa-plus-circle me-2"></i> Đăng ký ca làm
                                                </a>
                                            </li>
                                            <!-- Thêm mục "Xem đơn đăng ký ca làm" -->
                                            <li class="nav-item">
                                                <a href="/ShiftRegistration/viewWorkShiftRegistrationsForStaff" class="sidebar-link d-flex align-items-center py-2">
                                                    <i class="fas fa-list-alt me-2"></i> Xem đơn đăng ký ca làm
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="nav-item w-100">
                                    <a href="/Delivery/viewDeliveryDetailsForStaff" class="sidebar-link d-flex align-items-center px-3 py-2 w-100">
