...
<html>
    ...
    <body>
        <div class="container">
           ...
           <form action="/StaffSchedule/createStaffSchedule" method="POST" onsubmit="validateForm(event)">
                ...
                <button type="button" onclick="window.location.href = '/StaffSchedule/staffSchedule'">Quay lại</button>
            </form>
        </div>
    </body>
</html>
