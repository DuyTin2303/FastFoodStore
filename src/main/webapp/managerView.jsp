    ...
    <div class="header-buttons">
        ...
        <div class="btn-group ms-2">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="/ShiftRegistration/viewShiftRegistration">
                        <i class="fas fa-list me-2"></i> Xem đơn đăng ký ca làm
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="/StaffSchedule/staffSchedule">
            ...
            <ul class="dropdown-menu">
                   <li>
                    <a class="dropdown-item" href="/Delivery/viewOrdertoAssign">
                        <i class="fas fa-calendar-check me-2"></i> Gán nhân viên giao hàng
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="/Delivery/viewDeliveryHistoryForManager">
                        <i class="fas fa-list me-2"></i> xem lịch sử đơn hàng
                    </a>
                </li>
                 <li>
                    <a class="dropdown-item" href="/Delivery/trackDeliveryStatusforManager">
