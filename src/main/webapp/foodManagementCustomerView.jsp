                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="description-link" data-bs-toggle="modal" data-bs-target="#descriptionModal${food.id}">
                                            ...
                                            ${food.description.length() > 50 ? food.description.substring(0, 50).concat("...") : food.description}
                                        </span>
                                    </td>
                                    <td>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <span class="d-block mt-2 description-link" data-bs-toggle="modal" data-bs-target="#descriptionModal${food.id}">
                                        <i class="fas fa-star text-warning me-1"></i>
                                        ${food.description.length() > 30 ? food.description.substring(0, 30).concat("...") : food.description}
                                    </span>
                                </p>
                            </div>
                                ...
                                <div class="col-md-7">
                                    <div class="card">
                                        <div class="card-header bg-light">
                                            <h6 class="mb-0"><i class="fas fa-star text-warning me-2"></i>Miêu tả chi tiết</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="description-content">
                                                ${not empty food.description ? food.description : 'Chưa có miêu tả cho món ăn này.'}
                                            </div>
                                        </div>
                                    </div>
                                </div>
