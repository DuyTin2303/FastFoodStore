...
<html>
    ...
    <body>
        ...
        <div class="btn-container">
            <button onclick="location.href = '/StaffSchedule/createStaffSchedule'">Tạo Lịch Mới</button>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th class="hidden-id">ID Ca</th> <!-- Hidden column -->
                    <th>Tên Nhân Viên</th>
                    <th>Ngày Làm Việc</th>
                    <th>Giờ Làm Việc</th>
                    <th>Trạng Thái</th>
            ...
            <tbody>
                <c:forEach var="schedule" items="${schedules}">
                    <tr>
                        <td class="hidden-id">${schedule.shiftId}</td> <!-- Hidden column -->
                        ...
                        <td>
                            <button class="update-btn" onclick="location.href = '/StaffSchedule/updateStaffSchedule?shiftId=${schedule.shiftId}'">Cập nhật</button>
