...
<html lang="vi">
    ...
    <body>
        <div class="container"> <!-- Added missing container div -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="btn-group ms-2">
                                <button id="tableViewBtn" class="btn btn-outline-secondary" aria-label="Chế độ xem bảng">
                                    <i class="fas fa-list"></i>
                                </button>
                                <button id="gridViewBtn" class="btn btn-outline-secondary" aria-label="Chế độ xem lưới">
                                    <i class="fas fa-th"></i>
                                </button>
                            </div>
                        </div>
            ...
            <div id="tableView">
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="table-responsive"> <!-- Added for better mobile support -->
                                ...
                                <tbody>
                                    <c:forEach var="food" items="${foodList}">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="description-link" data-bs-toggle="modal" data-bs-target="#descriptionModal${food.id}">
                                                    <i class="fas fa-star text-warning me-1"></i>
                                                    ${not empty food.description ? (food.description.length() > 50 ? food.description.substring(0, 50).concat("...") : food.description) : 'Chưa có mô tả'}
                                                </span>
                                            </td>
                                            <td>
                            ...
                            <div class="food-card card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <span class="d-block mt-2 description-link" data-bs-toggle="modal" data-bs-target="#descriptionModal${food.id}">
                                            <i class="fas fa-star text-warning me-1"></i>
                                            ${not empty food.description ? (food.description.length() > 30 ? food.description.substring(0, 30).concat("...") : food.description) : 'Chưa có mô tả'}
                                        </span>
                                    </p>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="descriptionModalLabel${food.id}">Chi tiết món ăn: ${food.name}</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-5">
                                        <c:choose>
                                            <c:when test="${not empty food.imageUrl}">
                                                <img src="${food.imageUrl}" alt="${food.name}" class="description-modal-img">
                                            </c:when>
                                            <c:otherwise>
                                                <img src="images/default-food.jpg" alt="Default" class="description-modal-img">
                                            </c:otherwise>
                                        </c:choose>
                                    ...
                                    <div class="col-md-7">
                                        <div class="card">
                                            <div class="card-header bg-light">
                                                <h6 class="mb-0"><i class="fas fa-star text-warning me-2"></i>Mô tả chi tiết</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="description-content">
                                                    ${not empty food.description ? food.description : 'Chưa có mô tả cho món ăn này.'}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        </div> <!-- Proper closure of the container div -->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                <c:if test="${not empty selectedFood}">
                    var descriptionModal = new bootstrap.Modal(document.getElementById('descriptionModal${selectedFood.id}'));
