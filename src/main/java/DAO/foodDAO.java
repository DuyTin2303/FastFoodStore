...
public class foodDAO {
    ...
    public List<FoodItem> getAllFood() {
        List<FoodItem> result = getFoodByQuery("SELECT d.dish_id, d.dish_name, c.category_name, d.price, d.description, d.image_url "
    ...
    public List<FoodItem> getFoodByCategory(String category) {
        return getFoodByQuery("SELECT d.dish_id, d.dish_name, c.category_name, d.price, d.description, d.image_url "
    ...
    public List<FoodItem> getFoodByPrice(double maxPrice) {
        return getFoodByQuery("SELECT d.dish_id, d.dish_name, c.category_name, d.price, d.description, d.image_url "
                + "FROM Dishes d JOIN FoodCategories c ON d.category_id = c.category_id WHERE d.price <= ?",
                new Object[]{maxPrice});
    }
    ...
    public FoodItem getFoodById(int id) {
        String query = "SELECT d.dish_id, d.dish_name, c.category_name, d.price, d.description, d.image_url "
