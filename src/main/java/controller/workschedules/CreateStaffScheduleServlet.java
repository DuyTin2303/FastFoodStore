     ...
     */
    @WebServlet(name = "CreateStaffScheduleServlet", urlPatterns = {"/StaffSchedule/createStaffSchedule"})
    public class CreateStaffScheduleServlet extends HttpServlet {

        @Override
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                throws ServletException, IOException {
            request.getRequestDispatcher("/StaffSchedule/createStaffSchedule.jsp").forward(request, response);
        }
