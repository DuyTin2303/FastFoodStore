 ...
 */
@WebServlet(name = "UpdateStaffScheduleServlet", urlPatterns = {"/StaffSchedule/updateStaffSchedule"})
public class UpdateStaffScheduleServlet extends HttpServlet {
@Override
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    request.getRequestDispatcher("/StaffSchedule/updateStaffSchedule.jsp").forward(request, response);
}
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (idParam == null || idParam.isEmpty()) {
                response.sendRedirect("/StaffSchedule/staffSchedule.jsp?update=fail&error=invalid_id");
                return;
            }
            ...
            if (success) {
                response.sendRedirect("/StaffSchedule/staffSchedule");
            } else {
                response.sendRedirect("/StaffSchedule/staffSchedule.jsp?update=fail&error=db_update_failed");
            }
        } catch (NumberFormatException e) {
            response.sendRedirect("/StaffSchedule/staffSchedule.jsp?update=fail&error=invalid_id_format");
        } catch (Exception e) {
            response.sendRedirect("/StaffSchedule/staffSchedule.jsp?update=fail&error=unknown");
        }
    }
}
