...
@WebServlet(name = "ApproveShiftRegistrationServlet", urlPatterns = {"/StaffSchedule/approveShiftRegistration"})
public class ApproveShiftRegistrationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/StaffSchedule/approveShiftRegistration.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Initialize the StaffScheduleDAO
        StaffScheduleDAO staffScheduleDAO = new StaffScheduleDAO();

        // Call the approveShiftRegistration method to approve the shift registration
        boolean isApproved = staffScheduleDAO.approveShiftRegistration(registrationId, request.getSession());
        ...
        if (isApproved) {
            ...
            response.sendRedirect(request.getContextPath() + "/StaffSchedule/viewShiftRegistration");
        } else {
            // Log the failure
            ...
            response.sendRedirect(request.getContextPath() + "/StaffSchedule/approveShiftRegistration.jsp?message=Đã+có+lỗi+xảy+ra+khi+duyệt+đơn+đăng+ký.");
        }
    }
}
