 ...
 */
@WebServlet(name = "ViewDeliveryForStaffServlet", urlPatterns = {"/Delivery/viewDeliveryForStaff"})
public class ViewDeliveryForStaffServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/Delivery/viewDeliveryForStaff.jsp");
